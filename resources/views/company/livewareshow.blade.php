          ...
          <div class="row">
            ...
            if($user->name == 'admin' || $user->name =='manager'){ 
             @endphp
              ...
              <p>$ {{ucfirst($company->profile->deal_amount ?? 00)}}</p>
            </div>
            ...
            <div class="col-lg-4 mt-3">
              ...
              <p>{{ucfirst($company->profile->profile_service ?? '')}}</p>
            </div>

             <div class="col-lg-4 mt-3">
              <label><strong>Profile Start Date</strong></label>
              <p>{{$company->profile->start_date ?? ''}}</p>
            </div>

             <div class="col-lg-4 mt-3">
              <label><strong>Profile End Date</strong></label>
              <p>{{$company->profile->end_date ?? ''}}</p>
            </div>
             <div class="col-lg-4 mt-3">
        ...
        <div class="body">
          <form action="{{ route('company.addComment',$company) }}" method="post" >
            ...
            <div class="form-group mb-2 {{ $errors->first('message', 'has-error')}}">
              <textarea class="form-control" name="message" rows="8" placeholder="Add your comment">{{ old('message') }}</textarea>
