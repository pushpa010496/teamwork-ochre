      ...
      <li  {!! (Request::is('upload*') || Request::is('get-excel*') ? 'class="treeview active"' : 'class="treeview"') !!}>
        ...
        <li  {!! (Request::is('upload*') || Request::is('get-excel*') ? 'class="treeview active"' : 'class="treeview"') !!}>
          ...
          <ul class="treeview-menu">
            ...
            <li {!! (Request::is('get-excel*') ? 'class="active"' : '') !!}><a href="{{url('leave')}}"><i class="fa fa-circle-o"></i>Types</a></li>
            <li {!! (Request::is('docs-upload') ? 'class="active"' : '') !!}><a href="{{url('sheduled')}}"><i class="fa fa-circle-o"></i>Leave Process</a></li>
