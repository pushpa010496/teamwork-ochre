                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->first('dept_head', 'has-error')}}">                                    
                                                {!! Form::select('dept_head', $heads, null,['id'=>'','class' => 'form-control','placeholder'=>'Select Head of department'] ) !!}
                                        ...
                                        <tbody>
                                            ...
                                            @if($departmentinfo->count())
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$value->head['name']}}</td>
                                                    <td>{{ $value->employerees()->count() }}</td>
