     ...
     <div class="row">
        ...
        {!! Form::open(array('route' => 'task.store','files'=>true)) !!}
         ...
         <div class="form-group col-md-3 ">
            ...
            {!! Form::text('taskstart', null, array('id'=>'taskstart','postdt' => 'Name','class' => 'form-control dcp')) !!}
          ...
          <div class="form-group col-md-3 ">
            ...
            {!! Form::text('taskend', null, array('id'=>'taskend','postdt' => 'Name','class' => 'form-control dcp')) !!}
         </div>
 <div class="col-xs-3 col-sm-12 col-md-3">
        <div class="form-group">
            <strong>Work priority:</strong>
          {!! Form::select('type',['--Select--','High','Low'], null, array('class' => 'form-control')) !!}
        </div>
    </div>
