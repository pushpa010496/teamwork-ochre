                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs2">
                            <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#e_Email marketing">Email marketing</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="e_add">
                                <div class="body">
                                  ...
                                  {!! Form::open(array('route' => 'emailmarketing.store','files'=>true)) !!}
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-6 ">
                                            <div class="form-group {{ $errors->first('banner_name', 'has-error')}}">
                                                ...
                                                <input type="text" class="form-control" name="email_url" placeholder="Email" value="{{ old('email_url') }}" required="required">
                                                <span class="help-block">{{ $errors->first('email_url', ':message') }}</span>   
                                            </div>
                                        </div>
<div class="col-md-6 ">
                                         ...
                                         <div class="col-md-6 ">
                                            <div class="form-group {{ $errors->first('email_date', 'has-error')}}">
                                                <label>Start Date</label>
                                                <input type="date" class="form-control" name="email_date" placeholder="Start Date" value="{{ old('email_date') }}" required="required">
                                                <span class="help-block">{{ $errors->first('email_date', ':message') }}</span>   
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-md-6 ">
                                            <div class="form-group {{ $errors->first('end_date', 'has-error')}}">
                                                ...
                                                <input type="date" class="form-control" name="end_date" placeholder="Start Date" value="{{ old('end_date') }}" required="required">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable table-custom spacing5 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @if($emailmarketing->count())
                                                @foreach($emailmarketing as $key => $value)
                                                <tr>
                                                    <td>{{++$key}}</td>
                                                  ...
                                                  @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('sub-admin'))
                                                    <td>
                                                       <a class="btn btn-sm btn-warning" href="{{ route('emailmarketing.edit', $value->id) }}">
