            ...
            <div class="body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <input type="email" class="form-control round" id="signin-email" name="email" value="{{old('email')}}" placeholder="Email" style="color: #000000 !important;font-weight: 500 !important;">
                    ...
                    <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <input type="password" name="password"  class="form-control round" id="signin-password"  placeholder="Password" style="color: #000000 !important;font-weight: 500 !important;">
