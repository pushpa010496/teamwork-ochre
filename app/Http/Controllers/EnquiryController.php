...
class EnquiryController extends Controller
{
    ...
    {
      $data=Enquiry::with('companys')->get();
         $company=Company::get();
    ...
    public function update(Request $request,Enquiry $enquiry)
    {
        ...
        $enquiry->job_title = $request->input("job_title");     
        ...
        //$enquiry->profile_type = $request->profile_type;
        $enquiry->active_flag = 1;
        $enquiry->author_id = $request->user()->id;
